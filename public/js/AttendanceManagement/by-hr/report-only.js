    ...
    $(document).ready(function () {
        ...
        app.initializeKendoGrid($table, [
            ...
            {field: "FUNCTIONAL_TYPE_EDESC", title: "Functional Type", width: 70},
             {field: "IN_TIME", title: "Check In", width: 70, template: "<span>#: (IN_TIME == null) ? '-' : IN_TIME # </span>"},
            {field: "OUT_TIME", title: "Check Out", width: 70, template: "<span>#: (OUT_TIME == null) ? '-' : OUT_TIME # </span>"},
			{field: "TOTAL_HOUR", title: "Total Hour", width: 70, template: "<span>#: (TOTAL_HOUR == null) ? '-' : TOTAL_HOUR # </span>"},
