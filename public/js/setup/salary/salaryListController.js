(function ($, app) {
    ...
    $(document).ready(function () {
        ...
        app.initializeKendoGrid($employeeTable, [
            ...
            {field: "SALARY", title: "Salary", width: 150},
            {field: "SALARY_PF", title: "Salary Pf", width: 150},
            {field: "ALLOWANCE", title: "Allowance", width: 150},
            {field: "DEARNESS_ALLOWANCE", title: "Dearness Allowance", width: 150}, 
            {field: "CLOTH_TRANS_ALLOWANCE", title: "Cloth Trans Allowance", width: 150}, 
            {field: "FOOD_ALLOWANCE", title: "Food Allowance", width: 150},    
        ...
        var map = {
            ...
            'CLOTH_TRANS_ALLOWANCE': 'Cloth Trans Allowance',
...
//                exportData : exportData,
        ...
        $search.on('click', function () {
            ...
            app.serverRequest(document.pullSalaryListForEmployeeTableLink, data).then(function (response) {
                if (response.success) {
