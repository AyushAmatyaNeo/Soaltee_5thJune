...
LOAN_ID NUMBER(7,0) NOT NULL REFERENCES HRIS_LOAN_MASTER_SETUP (LOAN_ID),
...
alter table Hris_Loan_Master_Setup add acc_code_emp varchar2(30);

create table hris_loan_opening_balance(
acc_code varchar2(30) not null,
employee_id number not null,
OPENING_DATE date not null,
PARTICULARS varchar2(200),
TRANSACTION_TYPE char(2),
OPENING_AMOUNT NUMBER(14,2) not null,
CURRENCY_CODE             VARCHAR2(3) default 'NPR',
...
alter table hris_employee_loan_request add print_flag char(1);

alter table Hris_Loan_Cash_Payment add type char(3);