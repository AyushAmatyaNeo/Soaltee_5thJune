...
SELECT * FROM Hr_Advance_Request@EMPNEW
)
LOOP
...
FOR PD_LIST IN (
select * from Hr_Advance_Request_Detail@EMPNEW WHERE Request_No=LOAN_REQUEST_LIST.REQUEST_NO ORDER BY SERIAL_NO
)
LOOP
