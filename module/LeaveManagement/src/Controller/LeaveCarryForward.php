...
use LeaveManagement\Model\LeaveCarryForward as LeaveCarryForwardModel;
...
class LeaveCarryForward extends HrisController
{
    ...
    public function addAction()
    {
        ...
        if ($request->isPost()) {
            ...
            $leaveRequest = new LeaveCarryForwardModel();
            // $leaveRequest->exchangeArrayFromForm($this->form->getData());
            $leaveRequest->carryForwardDays = (empty($_POST['carryforward'])) ? 0 : $_POST['carryforward'];
            $leaveRequest->encashDays = (empty($_POST['encashment'])) ? 0 : $_POST['encashment'];
